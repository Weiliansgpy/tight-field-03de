...
```
npm create cloudflare@latest -- --template=cloudflare/templates/tight-field-03de
```

A live public deployment of this template is available at [https://tight-field-03de.templates.workers.dev](https://tight-field-03de.templates.workers.dev)
